...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categories for routes (Fragrance, Culture, Gastronomy, Fashion)';
...
export interface ApiCuratorCurator extends Struct.CollectionTypeSchema {
  collectionName: 'curators';
  info: {
    description: 'Route curators and experts';
    displayName: 'Curator';
    pluralName: 'curators';
...
export interface ApiRouteRoute extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tourist routes with stops';
    displayName: 'Route';
    pluralName: 'routes';
    singularName: 'route';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curator: Schema.Attribute.Relation<'manyToOne', 'api::curator.curator'>;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    ...
    experienceType: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Premium Experience'>;
    heroImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    toBring: Schema.Attribute.Text;
    totalPoints: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    totalStops: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weather: Schema.Attribute.Text;
  };
}
...
export interface ApiStopStop extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    timeAtStop: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    walkTime: Schema.Attribute.String;
  };
}
